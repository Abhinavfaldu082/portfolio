...
const IntroSection: FC = () => {
  ...
  return (
    <section
      id="home"
      className="bg-background min-h-screen flex items-center relative overflow-hidden"
    >
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 text-center md:text-left">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
              Hi, I&apos;m <span className="text-primary">Abhinav Faldu</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground">
              ...
              driven by curiosity and a love for uncovering insights from data.
              Eager to apply analytical skills and machine learning knowledge to
            ...
            <div className="flex justify-center md:justify-start space-x-4 mt-6">
              <Button variant="ghost" size="icon" asChild>
                <Link
                  href="https://www.linkedin.com/in/abhinav-faldu-46957124b/"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="LinkedIn"
                >
              ...
              <Button variant="ghost" size="icon" asChild>
                <Link
                  href="https://github.com/Abhinavfaldu082"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="GitHub"
                >
